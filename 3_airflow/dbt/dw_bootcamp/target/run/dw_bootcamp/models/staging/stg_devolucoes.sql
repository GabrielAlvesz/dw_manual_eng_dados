  ...
  create view "dbt_db"."public_staging"."stg_devolucoes__dbt_tmp"
...
typed as (
    select
        ...
        cast("motivo_devolucao" as text) as motivo_devolucao,
        cast("status_devolucao" as text) as status_devolucao
